...
namespace App\Services\ClassMarker;

use Exception;

class ClassMarkerClientService
{
    ...
    private function generateSignature(): string
    {
        ...
        return md5($this->api_key . $this->secret . $this->request_timestamp);
    }

    private function request(string $url, string $method, string $json_body = null): bool|string
    {
    ...
    /**
     * @param $path
     * @param null $finishedAfterTimestamp
     * @param null $limit
     * @return bool|string
     * @throws Exception
     */
    public function get($path, $finishedAfterTimestamp = null, $limit = null): bool|string
    {
