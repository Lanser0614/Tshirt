                        ...
                        <div class="tab-pane active" id="tab1">
                            <div class="well">
                                ...
                                <select id="tshirttype">
                                    <option value="{{ asset("img/crew_front.png") }}" selected="selected">Short Sleeve
                                        Shirts
                                    </option>
                                    <option value="{{ asset("img/mens_longsleeve_front.png") }}">Long Sleeve Shirts
                                    </option>
                                    <option value="{{ asset("img/mens_hoodie_front.png") }}">Hoodies</option>
                                    <option value="{{ asset("img/mens_tank_front.png") }}">Tank tops</option>
                                </select>
                                <!--						      </p>-->
                            </div>
                            <div class="well">
...
{{--                                        @php--}}
{{--                                        $path = Session::getId().'/'.$file;--}}
{{--//                                        $part = \Illuminate\Support\Facades\Storage::disk('public')->get($path);--}}
{{--//                                        dd($part);--}}
{{--                                         @endphp--}}
...
{{--                                @endif--}}
                                    ...
                                    <img style="cursor:pointer;" class="img-polaroid"
                                         src="{{ asset("img/invisibleman.jpg") }}">
                                    <img style="cursor:pointer;" class="img-polaroid"
            ...
            <div class="span6">
                    ...
                    <div class="clearfix">
                        <div class="btn-group inline pull-left" id="texteditor" style="display:none">
                            ...
                            <button id="text-bold" class="btn" data-original-title="Bold"><img
                                    src="{{ asset("img/font_bold.png") }}" height="" width=""></button>
                ...
                <div id="shirtDiv" class="page"
                    ...
                    <img name="tshirtview" id="tshirtFacing" src="{{ asset("img/crew_front.png") }} ">
                    <div id="drawingArea"
            ...
            <div class="span3">
                <div class="well">
                    ...
                    <button type="button" class="btn btn-large btn-block btn-success" name="addToTheBag"
                            id="addToTheBag">Add to bag <i class="icon-briefcase icon-white"></i>
                    </button>
                </div>
            </div>
...
<script>
    ...
    $('#flipback').click(
        function () {
            if (valueSelect === {{ asset("img/crew_front.png") }}) {
                if ($(this).attr("data-original-title") === "Show Back View") {
                    $(this).attr('data-original-title', 'Show Front View');
                    $("#tshirtFacing").attr("src", {{ asset("img/crew_back.png") }});
                    ...
                    $("#tshirtFacing").attr("src", {{ asset("img/crew_front.png") }});
            ...
            } else if (valueSelect === {{ asset("img/mens_longsleeve_front.png") }}) {
                if ($(this).attr("data-original-title") === "Show Back View") {
                    $(this).attr('data-original-title', 'Show Front View');
                    $("#tshirtFacing").attr("src", {{ asset("img/mens_longsleeve_back.png") }});
                    a = JSON.stringify(canvas);
                    canvas.clear();
                    try {
                        var json = JSON.parse(b);
                    ...
                    $(this).attr('data-original-title', 'Show Back View');
                    $("#tshirtFacing").attr("src", {{ asset("img/mens_longsleeve_front.png") }});
                    b = JSON.stringify(canvas);
                    canvas.clear();
                    try {
                        var json = JSON.parse(a);
            ...
            } else if (valueSelect === {{ asset("img/mens_tank_front.png") }}) {
                if ($(this).attr("data-original-title") === "Show Back View") {
                    $(this).attr('data-original-title', 'Show Front View');
                    $("#tshirtFacing").attr("src", {{ asset("img/mens_tank_back.png") }});
                    a = JSON.stringify(canvas);
                    canvas.clear();
                    try {
                        var json = JSON.parse(b);
                    ...
                    $(this).attr('data-original-title', 'Show Back View');
                    $("#tshirtFacing").attr("src", {{ asset("img/mens_tank_front.png") }});
                    b = JSON.stringify(canvas);
                    canvas.clear();
                    try {
                        var json = JSON.parse(a);
            ...
            } else if (valueSelect === {{ asset("img/mens_hoodie_front.png") }}) {
                if ($(this).attr("data-original-title") === "Show Back View") {
                    $(this).attr('data-original-title', 'Show Front View');
                    $("#tshirtFacing").attr("src", {{ asset("img/mens_hoodie_back.png") }});
                    a = JSON.stringify(canvas);
                    canvas.clear();
                    try {
                        var json = JSON.parse(b);
                    ...
                    $(this).attr('data-original-title', 'Show Back View');
                    $("#tshirtFacing").attr("src", {{ asset("img/mens_hoodie_front.png") }});
                    b = JSON.stringify(canvas);
                    canvas.clear();
                    try {
                        var json = JSON.parse(a);
